...
$('#text_color').on("change", function(){
 ...
 if( $.cookie('TextColorCookie') != undefined) {
    ...
    $('#link_color').on("change", function () {
        ...
        $('body a').not("#ADA_widget a").children().attr('style', 'color: ' + link_color + '!important');
    ...
    if ($.cookie('LinkColorCookie') != undefined) {
        ...
        $('body a').not("#ADA_widget a").children().attr('style', 'color: ' + $.cookie('LinkColorCookie') + '!important');
    ...
    // $('#ADA_reset').on("click", function () {
    //  resetColors('#212529', '#FFFFFF', '#3863ff')
    // });
