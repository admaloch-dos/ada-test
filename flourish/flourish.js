...
$(document).ready(function () {
  ...
  $('#background_color').on("change", function () {
    ...
    $('body, body *, li, a, ul').not('#flourish-widget-main, #flourish-widget-main *, .audio_state *, .curr-active-item *').not('.dropdown-menu, .dropdown-menu *,.bypass-flourish, .bypass-flourish *').css('background-color', background_color)
  ...
  $('#text_color').on("change", function () {
    ...
    $('body *').not('#flourish-widget-main, #flourish-widget-main *, a, i, .bypass-flourish, .bypass-flourish *').css('color', text_color);
  ...
  $('#link_color').on("change", function () {
    ...
    $('body a, body i').not('#flourish_widget, #flourish_widget *, #flourish-triggers, #flourish-triggers *, .HighlightLinks *, .HighlightHover *, .translate-language-span, .bypass-flourish, .bypass-flourish *').css('color', link_color).addClass('flourish-link-style');
