...
<!-- The Modal -->
<section id="flourish_widget" class="flourish_modal_background" aria-label="main flourish widget" >
    <!-- Modal content -->
...
const genLanguageBtns = (arr, destination) => {
  for (let i = 0; i < arr.length; i++) {
    ...
    langBtnContainer.innerHTML = `
        <button id="${divId}" class="flourish-language-btn lang-translate-selector">
...
const genSearchBtns = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    searchListItem.innerHTML = `
        <button id="${divId}" class="search-list-item lang-translate-selector">
